...
def parse_args(args):
    ...
    parser.add_argument("-i", "--interface", help="Interface to use with Responder and mitm6")
    ...
    parser.add_argument("-u", "--user", help="Credentials for attacks; format: DOMAIN/user:password")
    parser.add_argument("-sf", "--server-file", help="Newline separated file of IPs which will be attacked via PrinterBug")
    parser.add_argument("-s", "--server", help="Server which will be attacked")
    parser.add_argument("-dc", "--domain-controller",
                        help="Domain controller for attacks")
